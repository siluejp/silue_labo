    ...
    function setDevice($device = DEVICE_TYPE_PC){
        ...
        switch ($device){
            ...
            case DEVICE_TYPE_SMARTPHONE:
                ...
                break;
            case DEVICE_TYPE_PC:
//                require_once("/home/geneks/www/eccube-2.11.2/data/class/module/FBsdk/facebook.php");
                //$objFB = new Facebook(array( 'appId'  => '228165967249973', 'secret' => 'b05a943ccb344ea565c362b151c66a4a' ) );
//$objFB = new Facebook();
//                var_dump($objFB->getUser());
