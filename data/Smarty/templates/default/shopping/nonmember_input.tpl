...
<div id="undercolumn">
    <div id="undercolumn_customer">
        ...
        <div class="information">
            ...
            ・携帯電話のアドレスの方はwat-fbshop@select-wat.comからの<br/>
            受信設定を解除していただけるようお願いします。<br/>
        ...
        <div class="btn_area">
            <ul>
                <li>
                     <!--{if $tpl_prev_url == ""}-->
                     <a href="https://geneks.sakura.ne.jp/eccube-2.11.2/html/cart/?transactionid=<!--{$transactionid}-->" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_back_on.jpg','back<!--{$key}-->');" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_back.jpg','back<!--{$key}-->');">
