        ...
        <div class="bloc_body clearfix">
            ...
            <div class="recomendright clearfix">
                <div class="productImage">
                    ...
                    <img src="<!--{$smarty.const.ROOT_URLPATH}-->resize_image.php?image=<!--{$arrBestProducts[$cnt2].main_list_image|sfNoImageMainList|h}-->&amp;width=80&amp;height=53" alt="<!--{$arrBestProducts[$cnt2].name|h}-->" /></a>
                </div>
                <div class="productContents">
                    <h3>
