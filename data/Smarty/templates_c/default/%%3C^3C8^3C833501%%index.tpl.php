<?php /* Smarty version 2.6.26, created on 2011-12-22 15:39:11
...
//]]>
	...
	<?php if (((is_array($_tmp=$this->_tpl_vars['isIE'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
	<a target="_top" href="http://www.wat-shop.net/?mode=cate&cbid=1110265&csid=0" onclick="fnInCartSubmit();" onmouseover="chgImg('<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
